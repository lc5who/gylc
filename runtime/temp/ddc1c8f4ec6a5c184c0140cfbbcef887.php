<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:29:"../template/user/pwd_pay.html";i:1595507907;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <title>修改交易密码</title>
    <link rel="stylesheet" href="/Public/mobile/css/base.css?k=57528" />
...
<body>
    ...
    <div class="mobile">
        <div class="othertop">
            <a class="goback" href="/user/set_account.html"><img src="/Public/mobile/img/goback.png" /></a>
            <div class="othertop-font">修改交易密码</div>
        </div>
        <div class="header-nbsp"></div>
        <div class="login_bg">
            <form action="/user/pwd_pay.html" method="post" id="ifr">
                <div class="input_text cert">
                    <label>原交易密码</label>
                    <input type="text" name="oldpwd" id="oldpwd" placeholder="请输入交易密码(或原登录密码)">
                </div>
                <div class="input_text cert">
                    <label>新交易密码</label>
                ...
                <div class="mobile">
                    <span class="span_tit">注：首次修改所需的【原交易密码】即是您的注册时设置的【登录密码】，如忘记原【登录密码】请联系在线客服重置 </span>
                </div>
                <input type="submit" class="input_btn" value="完成修改" />
            </form>
        </div>
    </div>
    <script type="text/javascript">
