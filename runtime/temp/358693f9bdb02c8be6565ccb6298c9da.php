<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:26:"../template/user/bank.html";i:1595457529;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <title>银行入款</title>
    <link rel="stylesheet" href="/Public/mobile/css/base.css?k=66036" />
...
<body>
    ...
    <div class="mobile" style="background-color: #efefee;">
        ...
        <div style="color:#666;text-align: center;font-size: .4rem;padding-top: 20px;">
            银行入款 <?php echo input('money'); ?> 元
        </div>
        <div style="color:#f666;text-align:center;font-size:.3rem;padding-top:10px;">
            账户不定期更新<br />充值前务必先核对平台充值账户是否变更！
        </div>
        <div style="width: 100%;margin: auto;">
            <ul>
                <li>
                    <span>收款银行：</span>
                    <input type="text" value="<?php echo $payinfo['bankname']; ?>" readonly />
                </li>
                <li>
                    <span>收款人：</span>
                    <input type="button" value="复制" class="btn" />
                    <input type="text" value="<?php echo $payinfo['payee']; ?>" id="cname" readonly />
                </li>
                <li>
                    <span>收款账号：</span>
                    <input type="button" value="复制" class="btn2" />
                    <input type="text" value="<?php echo $payinfo['bankcard']; ?>" id="caccount" readonly />
                </li>
            </ul>
            <!-- <form method="post" action="/user/bank.html" id="ifr">
                <input type="hidden" value="PAY1595457330881" name="orderid" />
                <ul>
                    <li>
                        <span>付款人：</span>
