<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:34:"../template/mobile/calculator.html";i:1595454093;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>计算器</title>
    <link href="/Public/mobile/css/calculator.css" type="text/css" rel="stylesheet">
    ...
    <script type="text/javascript" src="/Public/mobile/js/calculator.js"></script>
</head>
<body>
<div class="mobile">
    <div class="c_othertop">
        <a class="c_goback" href="javascript:history.back();"><img src="/Public//mobile/img/goback.png" /></a>
        <div class="c_othertop-font">收益计算器</div>
    </div>
    <div class="c_calculatorCpmBox">
        <form class="c_calculatorCpmLeft">
            <div class="img_box"><img src="/Public/uploads/logo.png" /></div>
