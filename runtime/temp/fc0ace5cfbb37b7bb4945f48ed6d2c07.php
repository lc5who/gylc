<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:35:"../template/user/certification.html";i:1595462983;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <title>实名认证</title>
    <link rel="stylesheet" href="/Public/mobile/css/base.css?k=66586" />
...
<body>
    ...
    <div class="mobile">
        ...
        <div class="login_bg">
            <?php if($user['auth'] == 1): ?>
                <div class="input_text cert">
                    <label>姓名</label>
                    <input type="text" readonly="readonly" value="<?php echo $user['idname']; ?>" placeholder="输入姓名">
                </div>
                <div class="input_text cert">
                    <label>身份证号码</label>
                ...
                <?php else: ?>
                <form action="<?php echo url('user/certification'); ?>" method="post">
                    <div class="input_text cert">
                        <label>姓名</label>
        ...
        <div class="mobile">
            <span class="span_tit"> 1.实名信息无法变更！请务必使用本人身份证实名！<br />2. 如盗用他人身份信息实名认证，导致无法提现概不负责！</span>
        </div>
    </div>
</body>
