<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"/www/wwwroot/gylc.com/public/../application/admin/view/content/gift/add.html";i:1595509788;s:64:"/www/wwwroot/gylc.com/application/admin/view/layout/default.html";i:1583049507;s:61:"/www/wwwroot/gylc.com/application/admin/view/common/meta.html";i:1583049507;s:63:"/www/wwwroot/gylc.com/application/admin/view/common/script.html";i:1583049507;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-maxchange" data-rule="required" class="form-control" name="row[maxchange]" type="number">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-avaimage" data-rule="required" class="form-control" size="50" name="row[avaimage]" type="text">
