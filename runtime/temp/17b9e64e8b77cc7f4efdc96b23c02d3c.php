<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:25:"../template/index/sp.html";i:1595436163;}*/ ?>
...
<div class="main">
	...
	<div class="left-btn button1">
		...
		<span style="display:none;color:#FF6600;">0个</span>
	</div>
	<div class="left-btn button2">
		<img src="/sp/i/upload/c36805c72b879f826ecabb5b5d4ff596.png">
		<span style="display:none;color:#FF6600;">  没有树苗</span>
	</div>
...
<script>
	...
	$(function(){
		...
		$('.button5').css("top",$(".main").height()-$('.button5').height()-120);
		$('.button6').css("top",$(".main").height()-$('.button5').height()-50);
	});
...
{
	$.post("http://www.zhijianquyou.com/sp/task/reward",{id:id},function(rs){
